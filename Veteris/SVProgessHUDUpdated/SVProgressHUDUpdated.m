...
#import "SVProgressHUDUpdated.h"
#import <QuartzCore/QuartzCore.h>

@interface SVProgressHUDUpdated ()
...
@implementation SVProgressHUDUpdated
...
+ (SVProgressHUDUpdated*)sharedView {
    static dispatch_once_t once;
    static SVProgressHUDUpdated *sharedView;
    dispatch_once(&once, ^ { sharedView = [[SVProgressHUDUpdated alloc] initWithFrame:[[UIScreen mainScreen] bounds]]; });
    return sharedView;
}


+ (void)setStatus:(NSString *)string {
	[[SVProgressHUDUpdated sharedView] setStatus:string];
}

#pragma mark - Show Methods

+ (void)show {
    [[SVProgressHUDUpdated sharedView] showWithStatus:nil maskType:SVProgressHUDMaskTypeNone networkIndicator:NO];
}

+ (void)showWithStatus:(NSString *)status {
    [[SVProgressHUDUpdated sharedView] showWithStatus:status maskType:SVProgressHUDMaskTypeNone networkIndicator:NO];
}

+ (void)showWithMaskType:(SVProgressHUDMaskType)maskType {
    [[SVProgressHUDUpdated sharedView] showWithStatus:nil maskType:maskType networkIndicator:NO];
}

+ (void)showWithStatus:(NSString*)status maskType:(SVProgressHUDMaskType)maskType {
    [[SVProgressHUDUpdated sharedView] showWithStatus:status maskType:maskType networkIndicator:NO];
}

#pragma mark - Show then dismiss methods

+ (void)showSuccessWithStatus:(NSString *)string {
    [SVProgressHUDUpdated showImage:[UIImage imageNamed:@"SVProgressHUDUpdated.bundle/success.png"] status:string];
}

+ (void)showSuccessWithStatus:(NSString *)string duration:(NSTimeInterval)duration {
    [SVProgressHUDUpdated show];
    [SVProgressHUDUpdated showImage:[UIImage imageNamed:@"SVProgressHUDUpdated.bundle/success.png"] status:string];
}

+ (void)showErrorWithStatus:(NSString *)string {
    [SVProgressHUDUpdated showImage:[UIImage imageNamed:@"SVProgressHUDUpdated.bundle/error.png"] status:string];
}
...
+ (void)showImage:(UIImage *)image status:(NSString *)string {
    [[SVProgressHUDUpdated sharedView] showImage:image status:string duration:1.0];
}
...
+ (void)dismiss {
	[[SVProgressHUDUpdated sharedView] dismiss];
}

+ (void)dismissWithSuccess:(NSString*)string {
	[SVProgressHUDUpdated showSuccessWithStatus:string];
}

+ (void)dismissWithSuccess:(NSString *)string afterDelay:(NSTimeInterval)seconds {
    [[SVProgressHUDUpdated sharedView] showImage:[UIImage imageNamed:@"SVProgressHUDUpdated.bundle/success.png"] status:string duration:seconds];
}

+ (void)dismissWithError:(NSString*)string {
	[SVProgressHUDUpdated showErrorWithStatus:string];
}

+ (void)dismissWithError:(NSString *)string afterDelay:(NSTimeInterval)seconds {
    [[SVProgressHUDUpdated sharedView] showImage:[UIImage imageNamed:@"SVProgressHUDUpdated.bundle/error.png"] status:string duration:seconds];
}
...
- (void)showImage:(UIImage *)image status:(NSString *)string duration:(NSTimeInterval)duration {
    if(![SVProgressHUDUpdated isVisible])
        [SVProgressHUDUpdated show];
...
+ (BOOL)isVisible {
    return ([SVProgressHUDUpdated sharedView].alpha == 1);
}
